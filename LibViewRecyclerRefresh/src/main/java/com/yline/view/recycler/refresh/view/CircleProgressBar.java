package com.yline.view.recycler.refresh.view;
...
public class CircleProgressBar extends ImageView {
    ...
    public CircleProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // text
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RefreshProgress, defStyleAttr, 0);
        final float density = context.getResources().getDisplayMetrics().density;

        int textVisible = a.getInt(R.styleable.RefreshProgress_bar_text_visibility, 1);
        if (textVisible != 1) {
            isTextDraw = true;
        }
        textSize = a.getDimensionPixelOffset(R.styleable.RefreshProgress_bar_text_size, (int) (density * text_size));
        int textColor = a.getColor(R.styleable.RefreshProgress_bar_text_color, Color.BLACK);
        textPercentage = a.getInt(R.styleable.RefreshProgress_bar_text_progress, 0);
        a.recycle();
